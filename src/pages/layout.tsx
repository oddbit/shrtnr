...
const NAV_ITEMS: NavItem[] = [
  { id: "dashboard", href: "/_/dashboard", icon: "dashboard", label: "Dashboard" },
  { id: "links", href: "/_/links", icon: "link", label: "Links" },
  { id: "keys", href: "/_/keys", icon: "key", label: "API Keys" },
  { id: "settings", href: "/_/settings", icon: "settings", label: "Settings" },
];
  ...
  return (
    <html lang="en" data-theme={currentTheme}>
      ...
      <body>
        ...
        <script>{raw(adminClientScript(email, pkg.version))}</script>
      </body>
    </html>
  );
};
